...
[${await translate(server.lan, "Dashboard")}](https://www.mcstatusbot.site/dashboard) | [${translate(server.lan, "Invite Bot")}](https://discord.com/oauth2/authorize?client_id=816747912888975362&scope=bot&permissions=268749904) | [${translate(server.lan, "Privacy Policy")}](https://github.com/404invalid-user/MC-status-bot/blob/main/miscellaneous/Privacy_policy.md) | [${translate(server.lan, "Github")}](https://github.com/404invalid-user/MC-status-bot) | [${translate(server.lan, "Support Server")}](https://discord.gg/YzX5KdF4kq)`
