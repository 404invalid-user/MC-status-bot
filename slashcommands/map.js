    ...
    data: new SlashCommandBuilder()
        ...
        .addStringOption(option =>
            option.setName('world')
                .setDescription('the world you want to view (default: world)')
                .setRequired(true))
        .addStringOption(option =>
            option.setName('x')
                .setDescription('your x coordinate')
                .setRequired(true)
        )
        .addStringOption(option =>
            option.setName('y')
                .setDescription('your y coordinate')
                .setRequired(true)
        )
        .addStringOption(option =>
            option.setName('z')
                .setDescription('your z coordinate')
                .setRequired(true)
        )
        .addStringOption(option =>
