...
module.exports = async(guild, user, to, subject, body) => {
    const footer = 'this was an automated email sent from https://www.mcstatusbot.site to notify you of your minecraft server status if you do not want to receive these email please reply and ask (only me and the email owner can see replys)';
