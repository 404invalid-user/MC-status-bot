...
module.exports = {
    ...
    async execute(message, args, data) {
        ...
        if (args == 'playersonline') {
            ...
            var embedDescription = `${data.IP} was up for ${up * 5} minutes and down for ${down * 5} minutes. This means that ${data.IP} has a uptime percentage of ${Math.round(((up / (up + down)) * 100 + Number.EPSILON) * 100) / 100
                }%`
