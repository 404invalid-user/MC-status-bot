...
<template>
  <div class="bruh">
    <p>{{ translate('Category ID') }}:</p>
    <input type="text" v-model="server.CategoryId" />
    <p>{{ translate('Status Channel ID') }}:</p>
    <input type="text" v-model="server.StatusChannId" />
    <p>{{ translate('Member Channel ID') }}:</p>
    <input type="text" v-model="server.StatusChannId" />
